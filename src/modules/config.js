...
rules: { 
    empty: { label: 'Sur toute la longueur de cet itinéraire, il peut y avoir de un à plusieurs radars, de plusieurs types.', type: 'unknown', alert: 0, filter: true, basenames: [ 'GATSO_ALL', 'GATSO_unknown_0' ] },
